...
public class SQLiteDAO implements MP3Dao {
	...
	public int insert(MP3 mp3) {
		...
		params.addValue("name", mp3.getAuthor().getName());

		Number keyHolder;

		keyHolder = insertAuthor.executeAndReturnKey(params);

		params = new MapSqlParameterSource();
		params.addValue("name", mp3.getName());
		params.addValue("author_id", keyHolder.intValue());
	...
	public int insertList(List<MP3> listMP3) {
		// String sql = "insert into mp3 (name, author) VALUES (:author,
		// :name)";
		//
